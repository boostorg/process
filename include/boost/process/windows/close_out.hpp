...
void close_out<1,0>::on_setup<WindowsExecutor>(WindowsExecutor &e) const
{
...
template<>
template<typename WindowsExecutor>
void close_out<2,0>::on_setup<WindowsExecutor>(WindowsExecutor &e) const
{
...
template<>
template<typename WindowsExecutor>
void close_out<1,2>::on_setup<WindowsExecutor>(WindowsExecutor &e) const
{
    e.startup_info.hStdOutput = ::boost::detail::winapi::INVALID_HANDLE_VALUE_;
    e.startup_info.hStdError  = ::boost::detail::winapi::INVALID_HANDLE_VALUE_;
    e.startup_info.dwFlags   |= ::boost::detail::winapi::STARTF_USESTDHANDLES_;
