...
template<>
template<typename WindowsExecutor>
void async_out<1,-1>::on_setup(WindowsExecutor &e) const
{
}

template<>
template<typename WindowsExecutor>
void async_out<2,-1>::on_setup(WindowsExecutor &e) const
{
}

template<>
template<typename WindowsExecutor>
void async_out<1,2>::on_setup(WindowsExecutor &e) const
{
}
