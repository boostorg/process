...
struct basic_process_handle 
{
  ...
  basic_process_handle(Executor executor, pid_type pid)
      : pid_(pid), handle_(executor, detail::open_process_(pid))
  {
  }

  basic_process_handle(Executor executor, pid_type pid, native_handle_type process_handle)
...
extern template struct basic_process_handle<>;
#endif
