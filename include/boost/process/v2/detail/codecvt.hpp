...
#ifndef BOOST_PROCESS_V2_DETAIL_CODECVT_HPP
#define BOOST_PROCESS_V2_DETAIL_CODECVT_HPP
        ...
        const std::locale &loc = std::locale())
{
    ...
    if (ec)
        detail::throw_error(ec, "convert_chars");
    return res;
}
...
#endif //BOOST_PROCESS_V2_DETAIL_CODECVT_HPP
